    ...
    V: serde::de::Visitor<'de>,
{
    match value {
        ...
        value::Value::S32(v) => visitor.visit_i32(v),
        value::Value::S64(v) => visitor.visit_i64(v),
        value::Value::U32(v) => visitor.visit_u32(v),
        value::Value::U64(v) => visitor.visit_u64(v),
        value::Value::Fixed32(v) => visitor.visit_u32(v),
        value::Value::Fixed64(v) => visitor.visit_u64(v),
        value::Value::SFixed32(v) => visitor.visit_i32(v),
        value::Value::SFixed64(v) => visitor.visit_i64(v),
